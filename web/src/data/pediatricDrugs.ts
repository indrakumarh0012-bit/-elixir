...
export const pediatricDrugsDB: PediatricDrug[] = [
  ...
  },
  {
    ...
    name: "Oxcarbazepine",
    category: "Antiseizure",
    recommendedDose: "Start 8–10 mg/kg/day ÷ BD; titrate to 20–40 mg/kg/day (abs max ~2400 mg/day).",
    defaultDoseMgPerKg: 20,
    maxDosePerDayMg: 2400,
    frequencyOptions: ["BD", "q12h"],
    defaultFrequency: "BD",
    ...
    route: ["PO"],
    cautionsAndContraindications: [
      "Hyponatremia — check Na if lethargy or seizures worsen",
      "~25–30% cross-react with a carbamazepine rash",
      "Levels fall with enzyme inducers",
    ],
    instructions: "Give at the same times daily; do not stop abruptly. Increase weekly, not faster.",
    referenceSource: "Harriet Lane / Nelson",
    renalAdjustment: true,
    formulations: [
      f("Syrup", "300 mg/5 ml", 300, 5, ["Oxetol syrup", "Oxep"], { packSizes: ["100 ml"] }),
      f("Tablet / DT", "150 / 300 / 600 mg", 300, 1, ["Oxetol", "Oxcarb"], {}),
    ],
  },
  {
    id: "lamotrigine",
    name: "Lamotrigine",
    category: "Antiseizure",
    recommendedDose: "SLOW titration: 0.3 mg/kg/day × 2 wk (0.15 with valproate) → step up q2wk to 1–10 mg/kg/day maintenance.",
    defaultDoseMgPerKg: 5,
    maxDosePerDayMg: 400,
    frequencyOptions: ["OD", "BD"],
    defaultFrequency: "BD",
    ...
    route: ["PO"],
    cautionsAndContraindications: [
      "SJS/TEN with FAST titration — never shortcut the 2-weekly steps",
      "HALVE all doses when combined with valproate",
      "Stop at the first sign of rash and review urgently",
    ],
    instructions: "Titrate over weeks per schedule. The calculated dose here is the MAINTENANCE target, not the starting dose.",
    referenceSource: "Harriet Lane / Nelson",
    renalAdjustment: false,
    formulations: [
      f("Tablet / DT", "25 / 50 / 100 mg DT", 50, 1, ["Lamitor DT", "Lametec DT"], {}),
    ],
  },
  {
    id: "ethosuximide",
    name: "Ethosuximide",
    category: "Antiseizure",
    recommendedDose: "Absence seizures: start ~10 mg/kg/day → usual 20–30 mg/kg/day ÷ BD (abs max ~1500 mg/day).",
    defaultDoseMgPerKg: 20,
    maxDosePerDayMg: 1500,
    frequencyOptions: ["BD", "q12h"],
    defaultFrequency: "BD",
    ...
    route: ["PO"],
    cautionsAndContraindications: [
      "Covers ABSENCE seizures only — add valproate if generalized tonic-clonic seizures coexist",
      "GI upset — give with food",
      "Rare blood dyscrasias — CBC if unexplained fever / sore throat / bruising",
    ],
    instructions: "First-line for childhood absence epilepsy. Give with meals to reduce GI upset.",
    referenceSource: "Harriet Lane / Nelson",
    renalAdjustment: false,
    formulations: [
      f("Syrup", "250 mg/5 ml", 250, 5, ["Zarontin (imported)", "local compounding"], { packSizes: ["100 ml"] }),
